...
//
//     final randomData = randomDataFromJson(jsonString);

import 'dart:convert';

RandomData randomDataFromJson(String str) =>
    RandomData.fromJson(json.decode(str));

String randomDataToJson(RandomData data) => json.encode(data.toJson());
